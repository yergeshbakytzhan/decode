...
function showSlide(){
    ...
    if(images[slideIndex].length>0){
        slideImg.innerHTML = `<img src="${images[slideIndex]}" alt="" class="slide-img fade-in">`
    }else{
        slideImg.innerHTML = `<img src="${images[slideIndex]}" alt="" class="slide-img fade-out">`
    }
}
